...
def tournamentWinner(competitions, results):
    ...
    for idx, match in enumerate(competitions):	
		# Away won
		if results[idx] == 0:
			current_winner, team_winners = update_scores(match[1], current_winner, team_winners)
		else:
			current_winner, team_winners = update_scores(match[0], current_winner, team_winners)
